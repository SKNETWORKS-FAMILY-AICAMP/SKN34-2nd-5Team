"""위험유형·근거·전략 규칙. Streamlit·DB·파일 I/O에 의존하지 않는다.

archive/app_streamlit_v04/core/insights.py의 원본이었으며, 그 파일은
이제 이 모듈을 재노출하는 호환 wrapper다. Streamlit·API·export 스크립트가
전부 이 모듈 하나만 참조하도록 해서, 위험유형·근거·전략 규칙이 한 곳에만
존재하게 한다.
"""
...
from shared.retention.formatters import days, percent, safe_float, signed_phrase
