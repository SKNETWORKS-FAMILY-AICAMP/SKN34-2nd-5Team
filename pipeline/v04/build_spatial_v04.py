...
def required_paths(project_root: Path) -> dict[str, Path]:
    return {
        ...
        "restaurant_businesses": (
            project_root / "data" / "interim" / "restaurant_businesses.parquet"
        ),
        "culinary_businesses": (
            project_root
            / "data"
            / "interim"
            / "additional_culinary_businesses.parquet"
        ),
        "restaurant_reviews": (
            project_root / "data" / "interim" / "restaurant_reviews.parquet"
        ),
        "culinary_reviews": (
            project_root
            / "data"
            / "interim"
            / "additional_culinary_reviews.parquet"
        ),
        "cohort": (
            project_root
            / "data"
