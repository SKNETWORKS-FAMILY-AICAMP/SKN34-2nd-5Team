...
# 모델링 데이터셋 경로
modeling_dataset_output = config[
    'outputs'
]['modeling_dataset']
...
def process_business_data():
    ...
    CULINARY_OUT_PATH = INTERIM_DIR / "additional_culinary_businesses.parquet"
...
def extract_reviews():
    ...
    BUSINESS_CUL_PATH = INTERIM_DIR / "additional_culinary_businesses.parquet"
    
    # 생성할 결과 파일
    OUT_REST_PATH = INTERIM_DIR / "restaurant_reviews.parquet"
    OUT_CUL_PATH = INTERIM_DIR / "additional_culinary_reviews.parquet"
