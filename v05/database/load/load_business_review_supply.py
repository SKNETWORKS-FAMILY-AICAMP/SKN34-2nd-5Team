"""Load reviewed v05 business review-supply artifact into yelp_data.

The loader applies only v05/database/ddl/024_create_business_review_supply.sql,
...
DDL_PATH = (
    ...
    / "database"
    / "ddl"
    / "024_create_business_review_supply.sql"
)
...
ARTIFACT = Artifact(
    ...
    "business_review_supply_v04.parquet",
    (
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Load the reviewed v05 business review-supply Parquet artifact."
    )
    parser.add_argument(
        "--confirm-database",
        required=True,
...
def load_frame() -> pd.DataFrame:
    ...
    for flag in ("is_comparison_year", "is_selection_year"):
